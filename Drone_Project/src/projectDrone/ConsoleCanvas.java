...
public class ConsoleCanvas {
    ...
    ConsoleCanvas(int x, int y) throws InterruptedException {
        ...
        arenaMap = new char[ySize + 2][xSize + 2]; // Making 2d array size to avoid nullpointer exception error.
    ...
    public static void showIt(int x, int y) {
        ...
        if (x > DroneArena.xSize || y > DroneArena.ySize || y == 0 || x == 0) {
            System.out.println("Cannot print drone as it's OOB");
        } else {
            //System.out.println("DRONE POS: X:" + x + "\tY:" + y);
            arenaMap[y][x] = 'D';
        }
